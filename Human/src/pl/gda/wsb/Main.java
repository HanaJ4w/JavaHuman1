...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Person person3 = new Footballer("Flavio","Paixao","1984-09-19","Lechia Gdańsk", Position.atacker,3);
        ...
        Footballer footballer1 = new Footballer("Michał","Nalepa","1993-01-22","Lechia Gdańsk", Position.defender,4);
